        ...
        <div class="bg-white p-6 rounded-lg shadow-md">
            ...
            <form action="<?= BASE_URL ?>/admin/admin.php" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" id="name" name="name" value="<?= htmlspecialchars($kategori_to_edit['name']) ?>" required class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md">
                </div>
                <div class="flex items-center gap-2">
                    ...
                    <?php if ($action == 'edit'): ?>
                        <a href="?page=kategori" class="px-4 py-2 bg-gray-300 text-gray-800 rounded-md hover:bg-gray-400">Batal</a>
                    <?php endif; ?>
                </div>
            </form>
        </div>
    ...
    <div class="lg:col-span-2">
        <div class="bg-white p-6 rounded-lg shadow-md overflow-x-auto">
            <table class="min-w-full divide-y divide-gray-200">
                <thead><tr><th class="px-4 py-3 text-left font-medium">Nama Kategori</th><th class="px-4 py-3 text-left font-medium">Aksi</th></tr></thead>
                <tbody>
                <?php
