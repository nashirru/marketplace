...
// Panggil load_settings sekali di setiap halaman yang meng-include file ini
// Ini akan mengisi cache pengaturan untuk digunakan oleh navbar dan footer.
if (isset($conn)) { // Pastikan koneksi ada sebelum memuat
    load_settings($conn);
}
    ...
    <header class="bg-white shadow-md sticky top-0 z-50">
        <div class="container mx-auto px-4">
            <div class="flex items-center justify-between h-16">
                <a href="{$home_url}" class="flex items-center space-x-2 text-2xl font-bold text-indigo-600">
                    <img src="{$logo_url}" alt="Logo Warok Kite" class="h-8 object-contain">
                </a>
...
function footer() {
    ...
    $store_desc = get_setting('store_description', 'Marketplace #1 untuk produk otentik dari Ponorogo.');
        ...
        <div class="container mx-auto px-4 py-8">
            <div class="grid grid-cols-2 md:grid-cols-4 gap-8">
                <div>
                    ...
                    <p class="text-gray-400 text-sm">{$store_desc}</p>
                </div>
                <div>
                ...
                <div>
                    ...
                    <div class="flex space-x-4">
                        <a href="{$fb_url}" class="text-gray-400 hover:text-white" target="_blank">Facebook</a>
                        <a href="{$ig_url}" class="text-gray-400 hover:text-white" target="_blank">Instagram</a>
                    </div>
                </div>
            </div>
